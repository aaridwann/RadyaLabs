...
function NavbarComponent({ children, search ,dataFind }) {
  ...
  return (
    <>
      <div className={`w-full bg-white ${showNav ? " h-24 opacity-100" : "h-0 opacity-0"} duration-300 relative bg-gradient-to-b from-purple-600 to-purple-400 flex flex-col justify-center `}>
